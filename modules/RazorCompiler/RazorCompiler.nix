...
let
  pname = "Microsoft.CodeAnalysis.Razor.Compiler.CSharp";
  ...
  project = "Microsoft.CodeAnalysis.Razor.Compiler.CSharp";
in
buildDotnetModule {
  ...
  version = "1.0.0";
  projectFile = "src/Compiler/Microsoft.CodeAnalysis.Razor/src/${project}.csproj";
